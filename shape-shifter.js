...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('岁寒甲子|风犹新|七旬五载|卓越尘|求学潇湘|步入科|追随真理|志气凌|光阴如箭|岁月稠|经世济时|韶华易逝|丹心在|祝寿七旬|乐春秋');
  ...
  function performAction(value) {
    ...
    timedAction(function () {
      ...
      if (sequence.length === 0) {
        // 在最后一句展示完成后执行页面跳转
        window.location.href = '/birthmain/index.html';
      }
...
S.Dot = function (x, y) {
  ...
  this.c = new S.Color(153, 0, 0, this.p.a);
